...
public class ChallengeTimer implements TabExecutor {
        ...
        if(sender instanceof Player) {
            ...
            if(args.length == 1) {
                if(args[0].equalsIgnoreCase("start")) {
                    ...
                    player.sendMessage(ChallengePlugin.getPrefix() + ChatColor.RED + "You have to enter /timer <start> <stop> <reset> !");
                }
            } else {
